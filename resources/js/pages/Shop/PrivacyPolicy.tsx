...
export default function PrivacyPolicy({ products = [], privacyContent }: PrivacyPolicyProps) {
  const breadcrumbs = [
    { label: 'Home', url: '/' },
    { label: 'Privacy Policy', url: '/privacy-policy' },
  ];

  const header = privacyContent?.header;
  const isFullMode = privacyContent?.mode === 'full';
  const fullContent = privacyContent?.full_content;
