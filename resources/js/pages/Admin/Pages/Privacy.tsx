...
interface PrivacyProps {
  privacyContent: PrivacyContentCMS;
}
...
export default function Privacy({ privacyContent: initialContent }: PrivacyProps) {
  ...
  return (
    <AdminLayout title="Privacy Policy Customizer">
      <Head title="Privacy Policy Customizer — Admin Haarmonaa" />
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 tracking-tight">
            Privacy Policy Customizer
          </h1>
          <p className="text-xs sm:text-[13px] text-gray-500 mt-0.5">
            Configure customer personal information handling, 256-bit payment encryption disclosures, and cookie policies.
          </p>
        </div>
