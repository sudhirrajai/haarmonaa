...
export const HaarmonaaLogo: React.FC<HaarmonaaLogoProps> = ({ className = 'h-9 w-auto' }) => {
  return (
    <div className={`flex items-center select-none ${className}`}>
      ...
      >
        ...
        <g transform="translate(136, 2) scale(0.65)" fill="#101e33">
          {/* Left Wing */}
          ...
          {/* Antennae */}
          <path d="M12 8c-2-4-5-6-7-7M16 8c2-4 5-6 7-7" stroke="#101e33" strokeWidth="1" strokeLinecap="round" />
        </g>
        ...
        {/* Flourish underline flourish accent under H and last A */}
        <path
