...
if (! class_exists('TGM_Plugin_Activation')) {
    ...
    class TGM_Plugin_Activation
    {
         ...
         * does the tgmpa_init action hook, and hooks in the overlay to init.
         *
        ...
        /**
         * Initialise the overlay between this class and WordPress.
         *
        ...
        protected function is_core_update_page()
        {
            ...
            if ($screen->base === 'update-core') {
                ...
                return true;
            } elseif ($screen->base === 'update' && ! empty($_POST['action'])) { // phpcs:ignore WordPress.Security.NonceVerification.Missing
