...
class Customizer
{
    ...
    public function enqueue_preview_scripts()
    {
        ...
        wp_enqueue_script('glozin-customizer-preview', get_template_directory_uri().'/assets/js/backend/customizer-preview.js', ['customize-preview'], '', true);
    }
    ...
    public function get_option_default($name)
    {
        if (class_exists('Kirki') && isset(\Kirki::$fields[$name]) && isset(\Kirki::$fields[$name]['default'])) {
            ...
            $settings = array_reduce($this->config['settings'], 'array_merge', []);
